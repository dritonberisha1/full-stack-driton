...
class Home extends Component {
    ...
    likeUser = (userId) => {
        this.props.likeUser(userId).then(() => {
            this.props.fetchUsers();
    ...
    unlikeUser = (userId) => {
        this.props.unlikeUser(userId).then(() => {
            this.props.fetchUsers();
            this.props.getCurrentUser();
        })
    };
        ...
        return (
            <Fragment>
                ...
                {this.props.users && this.props.users.map(user => (
                    <User user={user} likeUser={this.likeUser} unlikeUser={this.unlikeUser} key={user.id} isLiked={this.isLiked(user.id)}></User>
                ))}
            </Fragment>
        );
    }
